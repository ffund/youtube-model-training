...
# classify itag for steady-state and filling-state data
dat <- dat[(dat$label=="F" | dat$label=="S") & dat$video!=0,]
...
saveRDS(mod, file=paste("../../output-itag-fused/", methods[as.integer(idx)], "-model.Rda", sep=""))
